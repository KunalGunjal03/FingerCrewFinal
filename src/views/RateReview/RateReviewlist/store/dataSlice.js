...
import { apiGetRateReviewlist } from 'services/faq';

export const getSurveyor = createAsyncThunk(
  'listsRateReviewList/data/getSurveyor',
  async (data) => {
    try {
      const response = await apiGetRateReviewlist(data);
