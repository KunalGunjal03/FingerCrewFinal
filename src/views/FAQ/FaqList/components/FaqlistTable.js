        ...
        () => [
            ...
            },    
            {
                ...
                cell: (props) => {
                    ...
                    return <span className="capitalize">{row.lookup_id}</span>
                },
            },
            {
              header: 'faq_title',
              accessorKey: 'faq_title',
              cell: (props) => {
                  const row = props.row.original
                  return <span className="capitalize">{row.faq_title}</span>
              },
            },
            {
              header: 'faq_description',
              accessorKey: 'faq_description',
              cell: (props) => {
                  const row = props.row.original
                  return <span className="capitalize">{row.faq_description}</span>
              },
            },
        ],
        []
