    ...
    return (    
        <div className="flex items-center">
           {/* <Avatar size={28} shape="circle" src={Img} /> */}
            {/* {row.registration_no} */}
            <span className={`ml-2 rtl:mr-2 font-semibold`}>{row.surveyor_name}</span>
        </div>
    )
}
    ...
    const columns = useMemo(
        () => [
            ...
            },
            {
                ...
                cell: (props) => {
                    const row = props.row.original
                    return <span className="capitalize">{row.SurveyCount}</span>
                },
            },
            {
                header: 'rating',
                ...
                cell: (props) => {
                    const row = props.row.original
                    return <span className="capitalize">{row.rating}</span>
                },
            },
            {
                header: 'Status',
