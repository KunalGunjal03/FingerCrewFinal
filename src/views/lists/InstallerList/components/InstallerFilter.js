...
const FilterForm = forwardRef(({ onSubmitComplete}, ref) => {
  ...
  const handleSubmit = (values) => {
    ...
    console.log(payload)    
    dispatch(getInstaller(payload));
  };  
  const [selected, setSelected] = useState('created_date');
...
// };
  ...
  const onStatusFilterChange = (e) => {
    setSelected(e.value);
    setDateFilterVisible(e.value === 'created_date');
