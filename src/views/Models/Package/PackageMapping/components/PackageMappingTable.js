...
const ActionColumn = ({ row }) => {
    ...
    const onEdit = () => {
        navigate(`/viewPackageMapping/${row.installer_master_id}`)
    }
...
export default PackageMappingTable