...
const Customers = () => {
    const dispatch = useDispatch()
    const data1 = useSelector((state) => state.crmCustomers.data.statisticData.totalActiveSurveyor)
    const data = useSelector((state) => state.crmCustomers.data.statisticData.surveyors)
    console.log(data)
