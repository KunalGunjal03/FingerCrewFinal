...
const FilterForm = forwardRef(({ onSubmitComplete}, ref) => {
  ...
  const [userIdFilterVisible, setuserIdFilterVisible] = useState(false);
  const[UserRoleFilterVisible ,setUserRoleFilterVisible]=useState(false);
  ...
  const SearchByuserName = () => {
    return (
      <div className="grid grid-cols-1 lg:grid-cols-3 mt-8">
        ...
        <div className="lg:col-span-2 ">
          <Field type="text" autoComplete="off" name="userrName" placeholder="user Name" component={Input} />
        </div>
      </div>
    );
  };
  const SearchByuserRole = () => {
    return (
      <div className="grid grid-cols-1 lg:grid-cols-3 mt-8">
        ...
        <div className="lg:col-span-2 ">
          <Field type="text" autoComplete="off" name="userRole" placeholder="User Role" component={Input} />
        </div>
      </div>
    );
  };
...
// };
  ...
  useState(() => {
    setSelected();
    setUserRoleFilterVisible(false);
    setuserIdFilterVisible(false);
  ...
  const onStatusFilterChange = (e) => {
    ...
    setuserIdFilterVisible(e.value === 'username');
    setUserRoleFilterVisible(e.value === 'user_role');
  };
        ...
        <Form>
          <FormContainer>
            <FormItem invalid={errors.name && touched.name} errorMessage={errors.name}>
              ...
              {userIdFilterVisible && <SearchByuserName />}
              {UserRoleFilterVisible && <SearchByuserRole/>} 
            </FormItem>
          </FormContainer>
        </Form>
      )}
